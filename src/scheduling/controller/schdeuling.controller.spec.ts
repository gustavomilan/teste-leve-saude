...
describe('SchedulingController', () => {
  ...
  describe('postScheduling', () => {
    it('should handle default exception', async () => {
      ...
      const responde = await controller.postScheduling({
        medico_id: 'anything' as any,
        paciente_nome: 'anything' as any,
        data_horario: 'anything' as any,
      });
    ...
    it('should return validantion errors', async () => {
      ...
      const response = await controller.postScheduling({
        medico_id: 'incorret id' as any,
        paciente_nome: 'test name',
        data_horario: 'teste data',
      });
    ...
    it('should return service data', async () => {
      const response = await controller.postScheduling({
        medico_id: 1,
        paciente_nome: 'Oracio',
        data_horario: '11.11.2024',
      });
